"""Regulation M-B legal moves for Pokemon Champions.

Full move pool from Serebii Champions moves list, plus spread-move subsets
used by the battle log completer.

Sources:
- https://www.serebii.net/pokemonchampions/moves.shtml
- Spread geometry: MetaVGC / existing project targeting rules
"""
...
REGULATION_MB_MOVES: frozenset[str] = frozenset(
    {
        "Accelerock",
        "Acid Armor",
        "Acid Spray",
